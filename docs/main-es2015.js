...
let HomeComponent = class HomeComponent {
    constructor(patientService, toastr) {
...
let MedicineDialogComponent = class MedicineDialogComponent {
...
MedicineDialogComponent.ctorParameters = () => [
...
let MedicineComponent = class MedicineComponent {
    constructor(medicineService, dialog, toastr) {
    ...
    openDialog(elementdata) {
        ...
        const dialogRef = this.dialog.open(_medicine_dialog_medicine_dialog_component__WEBPACK_IMPORTED_MODULE_5__["MedicineDialogComponent"], dialogConfig);
...
let PatientComponent = class PatientComponent {
    constructor(patientService, router, toastr, route) {
        this.patientService = patientService;
        this.router = router;
        this.toastr = toastr;
        this.route = route;
...
let SinglePatientComponent = class SinglePatientComponent {
    constructor(patientService, adviceService, encounterService, medicineService, examinationService, symptomService, toastr, route) {
        this.patientService = patientService;
...
SinglePatientComponent.ctorParameters = () => [
    { type: _services_patient_service__WEBPACK_IMPORTED_MODULE_2__["PatientService"] },
